<!--- As usual, we'll write the YAML front matter --->
<!--- Also, anything inside these arrows (< >), with 3 dashes are commented, and are not visible on the website --->
---
title: "Markup: Image Alignment"
categories:  <!--- Category of your post --->
  - Markup
tags:		 <!--- Tags on your post, for related posts, and easy navigation --->
  - alignment
  - captions
  - content
  - css
